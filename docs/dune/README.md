...
- **Other-venue stock liquidity: $26.7M, not the $4.1M first measured.** The first probe truncated after 112 pools and understated it sixfold. The full census finds **2,456 pools holding exactly one listed token** (2,311 on the v3 factory `0x1f7d7550…2efa`, 145 on the v2 factory `0x8bceaa40…937f`) carrying $26.72M of stock: NVDA $4.26M across 601 pools, GLD $3.41M, SGOV $2.61M, SPY $1.43M, CRCL $1.36M, RDDT $1.16M, HIMS $1.05M, USO $1.05M, SPCX $0.90M across 330 pools.
  That is 48% of what the v4 PoolManager holds, so total DEX stock liquidity is **$82.9M, not $56.1M**, and LONG's share of it is **17.6%, not the 24.2% the site published**. A venue family holding a third of all tokenized stock was missing from the denominator, which is a sufficient explanation for the volume-share gap on its own.
